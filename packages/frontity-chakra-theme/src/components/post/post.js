...
import { getPostData, formatPostData, getSlickImage } from "../helpers";
...
// })();
  ...
  return (
    <LightPatternBox showPattern={state.theme.showBackgroundPattern} ref={ref}>
      <SlickSlid imgList={state.source.page[6]['_links']['wp:attachment'][0].href}></SlickSlid>
